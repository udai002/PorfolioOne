        ...
        <div>
            ...
            <div className="grid grid-cols-8 gap-16 w-full p-10">
                <div className='col-span-3 flex flex-col items-start justify-start text-lg'>
                    ...
                    <p className='font-medium py-4'>Hi, I'm Squart, a web developer and UI/UX designer with a passion for creating beautiful, functional,
                        and user-centered digital experiences. With 4 years of experience in the field. I am always looking for
                        new and innovative ways to bring my clients' visions to life.</p>
                    <p className='font-medium py-4'>I believe that design is about more than just making things look pretty – it's about solving problems and
                        creating intuitive, enjoyable experiences for users. </p>
                    <p className='font-medium py-4'>Whether I'm working on a website, mobile app, or
